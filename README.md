...
**Description:** Imagine searching for a product on Amazon — for example, a *"tumbler with a floral motif"* priced $10–$30 and highly rated. This project builds a **hybrid vector search system** that combines **text embeddings** with **metadata filters** to handle this type of filtered product search efficiently. The system achieves **baseline-level recall** while running **10–30× faster** than standard approaches.  
